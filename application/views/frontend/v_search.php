...
<div class="intro intro-single route bg-image"
    ...
    <div class="intro-content display-table">
        <div class="table-cell">
            <div class="container">
                <h2 class="intro-title mb-4" data-aos="zoom-in">Pencarian</h2>
                <ol class="breadcrumb d-flex justify-content-center">
                    <li class="breadcrumb-item" data-aos="zoom-in-down">
                        <a href="<?= base_url(); ?>">Home</a>
                    </li>
                    <li class="breadcrumb-item" data-aos="zoom-in-up">
                        <a href="<?= base_url('blog'); ?>">Cari</a>
                    </li>
                    <li class="breadcrumb-item active" data-aos="zoom-in-down"><?= $cari; ?></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8" data-aos="zoom-in">
                ...
                <div class="post-box">
                    ...
                    <div class="post-meta" data-aos="zoom-in-up">
                        <h1 class="article-title" data-aos="zoom-in-up">
